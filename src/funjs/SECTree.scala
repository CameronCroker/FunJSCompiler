...
object SECTree {
    ...
    case class IDeRef (name: Name, field: Name) extends Instr

    case class IObj (fields: Map[Name, Frame]) extends Instr
    /**
    ...
    case class MObj (fields: Map[Name, Frame]) extends MValue

// you may need something here :)
}
